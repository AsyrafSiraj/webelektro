...
<main>
	...
	<div class="table-data " >
		<div class="order">	
			...
			<form method="post" action="/dashboard/fasilitas/{{ $data->id }}" enctype="multipart/form-data" class="col-lg-11 col-sm-11 col-7">
                @method('put')
				@csrf
				<div class="mb-3">
				...
				<div class="mb-3">
					...
					<input type="hidden" name="oldImage" value="{{ $images[0]->image }}">
					@if ($images[0]->image)
						<img src="{{ asset('storage/' . $images[0]->image) }}" class="img-preview img-fluid mb-3 col-5 d-block">
					@else						
